...
if [ ! -d /datadisk/private-ethereum/bootnode/data/geth/chaindata ]; then
    ...
    /usr/bin/geth init --datadir /datadisk/private-ethereum/bootnode/data /datadisk/private-ethereum/genesis.json >> /datadisk/private-ethereum/bootnode/eth.log
    echo "...done!"
else
...
if [ ! -d /datadisk/private-ethereum/rpcnode/data/geth/chaindata ]; then
    ...
    /usr/bin/geth init --datadir /datadisk/private-ethereum/rpcnode/data /datadisk/private-ethereum/genesis.json >> /datadisk/private-ethereum/rpcnode/eth.log
    echo "...done!"
else
...
if [ ! -d /datadisk/private-ethereum/minernode/data/geth/chaindata ]; then
    ...
    /usr/bin/geth init --datadir /datadisk/private-ethereum/minernode/data /datadisk/private-ethereum/genesis.json >> /datadisk/private-ethereum/minernode/eth.log
    echo "...done!"
else
